...
ANDROID_STL_PATH = '/home/mark/code/android-ndk-r8e/sources/cxx-stl/gnu-libstdc++/4.7'
...
DEFINES = { 'ANDROID_BUILD', 'ARM_BUILD','__STDC_CONSTANT_MACROS', '__STDC_LIMIT_MACROS' }
BUILD_OPTIONS = { '--sysroot=' .. SYS_ROOT .. ' -std=c++0x -mfloat-abi=softfp' }
LINK_OPTIONS = { '-Wl,-rpath-link=' .. ANDROID_PLATFORM_LIBS .. ' -L' .. ANDROID_PLATFORM_LIBS }

FFMPEG_LINKS = { 'avformat', 'avcodec', 'avutil', 'swscale' }
LINKS = {}
SYSTEM_LINKS = { 'pthread', 'rt', 'libgnustl_shared' }
